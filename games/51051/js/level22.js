...
create: function()
{
	...
	// Row 1
	object1 = game.add.sprite(216, 101, 'number2');
	object1 = game.add.sprite(360, 101, 'number1');
	object1 = game.add.sprite(504, 101, 'number3');
	object1 = game.add.sprite(648, 101, 'blueblock');
	questionMark = game.add.bitmapText(680, 111, 'doctorSoosWhite', '5', 60); 
	questionMark.anchor.setTo(.5,0);
	operator = game.add.sprite(296, 111, 'multiply');
	operator = game.add.sprite(440, 111, 'minus');
	equal = game.add.sprite(586, 111, 'equal');
	
	// Row 2
	object2 = game.add.sprite(216, 174, 'number3');
	object2 = game.add.sprite(360, 174, 'number2');
	object2 = game.add.sprite(504, 174, 'number4');
	object2 = game.add.sprite(648, 174, 'purpleBlock');
	questionMark = game.add.bitmapText(680, 184, 'doctorSoosWhite', '10', 48); 
	questionMark.anchor.setTo(.5,0);
	operator = game.add.sprite(296, 184, 'multiply');
	operator = game.add.sprite(440, 184, 'minus');
	equal = game.add.sprite(586, 184, 'equal');
	
	// Row 3
	object3 = game.add.sprite(216, 247, 'number4');
	object3 = game.add.sprite(360, 247, 'number3');
	object3 = game.add.sprite(504, 247, 'number5');
	object3 = game.add.sprite(648, 247, 'orangeBlock');
	questionMark = game.add.bitmapText(680, 257, 'doctorSoosWhite', '17', 48); 
	questionMark.anchor.setTo(.5,0);
	operator = game.add.sprite(296, 257, 'multiply');
	operator = game.add.sprite(440, 257, 'minus');
	equal = game.add.sprite(586, 257, 'equal');
	
	// Row 4
	object4 = game.add.sprite(216, 320, 'number5');
	object4 = game.add.sprite(360, 320, 'number4');
	object4 = game.add.sprite(504, 320, 'number6');
	object4 = game.add.sprite(648, 320, 'greenblock');
	questionMark = game.add.bitmapText(680, 330, 'doctorSoosWhite', '26', 48); 
	questionMark.anchor.setTo(.5,0);
	operator = game.add.sprite(296, 324, 'multiply');
	operator = game.add.sprite(440, 324, 'minus');
	equal = game.add.sprite(586, 330, 'equal');
	
	// Row 5 (question)
	object4 = game.add.sprite(216, 393, 'number6');
	object4 = game.add.sprite(360, 393, 'number5');
	object4 = game.add.sprite(504, 393, 'number7');
	
	operator = game.add.sprite(296, 403, 'multiply');
	operator = game.add.sprite(440, 403, 'minus');
	equal = game.add.sprite(586, 403, 'equal');
	
	block = game.add.sprite(648, 393, 'yellowblock');
