...
create: function()
{
	...
	// Row 1
	object1 = game.add.sprite(288, 174, 'item4');
	operator = game.add.sprite(368, 184, 'plus');
	object1 = game.add.sprite(432, 174, 'item2');
	equal = game.add.sprite(512, 184, 'equal');
	
	result = game.add.sprite(576, 174, 'number8');
	
	// Row 2
	object2 = game.add.sprite(144, 247, 'number6');
	object2 = game.add.sprite(288, 247, 'item4');
	object2 = game.add.sprite(432, 247, 'number5');
	object2 = game.add.sprite(576, 247, 'item2');
	
	operator = game.add.sprite(224, 257, 'multiply');
	operator = game.add.sprite(368, 257, 'minus');
	operator = game.add.sprite(512, 257, 'multiply');
	
	equal = game.add.sprite(657, 257, 'equal');
	
	block = game.add.sprite(720, 247, 'redblock');
	result = game.add.bitmapText(735, 257, 'doctorSoosWhite', '15', 44); 
	
	// Row 4
	object4 = game.add.sprite(216, 393, 'item4');
	object4 = game.add.sprite(288, 393, 'item4');
	object4 = game.add.sprite(432, 393, 'item2');
	object4 = game.add.sprite(504, 393, 'item2');
	
	operator = game.add.sprite(369, 403, 'multiply');
