...
create: function()
{
	...
	// Row 1
	object3 = game.add.sprite(360, 174, 'item4');
	equal = game.add.sprite(440, 184, 'equal');
	block = game.add.sprite(504, 174, 'number9');
	
	// Row 2
	object4 = game.add.sprite(144, 320, 'item4');
	operator = game.add.sprite(222, 330, 'plus');
	object4 = game.add.sprite(288, 320, 'item4');
	operator = game.add.sprite(368, 330, 'divide');
	object4 = game.add.sprite(432, 320, 'item4');
	operator = game.add.sprite(512, 330, 'minus');
	object4 = game.add.sprite(576, 320, 'item4');
	equal = game.add.sprite(657, 330, 'equal');
	block = game.add.sprite(720, 320, 'orangeBlock');
	
	questionMark = game.add.bitmapText(752, 328, 'doctorSoosWhite', '?', 60); 
