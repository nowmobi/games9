...
create: function()
{
	...
	// question text
	var textQuestion = game.add.bitmapText(W/2, 63, 'doctorSoosBlack', 'What number should come next?', 32); 
	...
	// Row 4 (question)
	object4 = game.add.sprite(288, 247, 'greenblock');
	questionMark = game.add.bitmapText(321, 253, 'doctorSoosWhite', '3', 54); 
	questionMark.anchor.setTo(.5,0);
	
	object4 = game.add.sprite(360, 247, 'orangeBlock');
	questionMark = game.add.bitmapText(393, 253, 'doctorSoosWhite', '15', 54); 
	questionMark.anchor.setTo(.5,0);
	
	object4 = game.add.sprite(432, 247, 'redblock');
	questionMark = game.add.bitmapText(465, 253, 'doctorSoosWhite', '39', 54); 
	questionMark.anchor.setTo(.5,0);
	
	object4 = game.add.sprite(504, 247, 'blueblock');
	questionMark = game.add.bitmapText(537, 253, 'doctorSoosWhite', '75', 54); 
	questionMark.anchor.setTo(.5,0);
	
	// question block
	block = game.add.sprite(576, 247, 'purpleBlock');
	questionMark = game.add.bitmapText(609, 255, 'doctorSoosWhite', '?', 60); 
	questionMark.anchor.setTo(.5,0);
