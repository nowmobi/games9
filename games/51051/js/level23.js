...
create: function()
{
	...
	// Row 1
	object1 = game.add.sprite(216, 101, 'number4');
	object1 = game.add.sprite(360, 101, 'number3');
	object1 = game.add.sprite(504, 101, 'number1');
	object1 = game.add.sprite(576, 101, 'number4');
	
	operator = game.add.sprite(296, 111, 'multiply');
	equal = game.add.sprite(440, 111, 'equal');
	
	// Row 2
	object2 = game.add.sprite(216, 174, 'number5');
	object2 = game.add.sprite(360, 174, 'number4');
	object2 = game.add.sprite(504, 174, 'number2');
	object2 = game.add.sprite(576, 174, 'number3');
	
	operator = game.add.sprite(296, 184, 'multiply');
	equal = game.add.sprite(440, 184, 'equal');
	
	// Row 3
	object3 = game.add.sprite(216, 247, 'number6');
	object3 = game.add.sprite(360, 247, 'number5');
	object3 = game.add.sprite(504, 247, 'number3');
	object3 = game.add.sprite(576, 247, 'number4');
	...
	object4 = game.add.sprite(360, 393, 'number6');
