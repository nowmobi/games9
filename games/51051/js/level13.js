...
create: function()
{
	...
	// Row 1
	object1 = game.add.sprite(360, 101, 'item5');
	object1 = game.add.sprite(504, 101, 'item5');
	
	operator = game.add.sprite(440, 111, 'plus');
	equal = game.add.sprite(584, 111, 'equal');
	block = game.add.sprite(648, 101, 'redblock');
	
	result = game.add.bitmapText(680, 141, 'doctorSoosWhite', '10', 44);
	result.anchor.setTo(.5,.5);
	
	// Row 2
	object1 = game.add.sprite(216, 174, 'item5');
	object1 = game.add.sprite(360, 174, 'item4');
	object1 = game.add.sprite(504, 174, 'item4');
	...
	// Row 3
	object4 = game.add.sprite(144, 247, 'item5');
	operator = game.add.sprite(222, 257, 'multiply');
	object4 = game.add.sprite(288, 247, 'item4');
	operator = game.add.sprite(368, 257, 'minus');
	object4 = game.add.sprite(432, 247, 'item6');
	operator = game.add.sprite(512, 257, 'multiply');
	object4 = game.add.sprite(576, 247, 'item5');
	equal = game.add.sprite(657, 257, 'equal');
	block = game.add.sprite(720, 247, 'item5');
	
	// Row 4
	object3 = game.add.sprite(360, 393, 'item6');
	
	operator = game.add.sprite(296, 3403, 'plus');
	equal = game.add.sprite(440, 403, 'equal');
	
	block = game.add.sprite(504, 393, 'redblock');
	questionMark = game.add.bitmapText(536, 403, 'doctorSoosWhite', '?', 60); 
