...
create: function()
{
	...
	// Row 1
	object1 = game.add.sprite(216, 101, 'item5');
	object1 = game.add.sprite(360, 101, 'item4');
	object1 = game.add.sprite(504, 101, 'number1');
	object1 = game.add.sprite(576, 101, 'number2');
	object1 = game.add.sprite(648, 101, 'number0');
	
	operator = game.add.sprite(296, 111, 'plus');
	equal = game.add.sprite(440, 111, 'equal');
	
	// Row 2
	object2 = game.add.sprite(216, 174, 'item5');
	object2 = game.add.sprite(360, 174, 'item1');
	object2 = game.add.sprite(504, 174, 'number1');
	...
	// Row 3
	object3 = game.add.sprite(216, 247, 'item4');
	object3 = game.add.sprite(360, 247, 'item1');
	object3 = game.add.sprite(504, 247, 'number5');
	object3 = game.add.sprite(576, 247, 'number0');
	
	operator = game.add.sprite(296, 257, 'plus');
	equal = game.add.sprite(440, 257, 'equal');
	
	// Row 4
	object3 = game.add.sprite(360, 393, 'item4');
	equal = game.add.sprite(440, 403, 'equal');
	
	block = game.add.sprite(504, 393, 'greenblock');
