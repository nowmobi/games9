...
create: function()
{
	...
	// Row 1
	object1 = game.add.sprite(288, 101, 'item1');
	equal = game.add.sprite(368, 111, 'equal');
	object1 = game.add.sprite(432, 101, 'number5');
	operator = game.add.sprite(512, 111, 'plus');
	object1 = game.add.sprite(576, 101, 'number2');
	
	// Row 2
	object2 = game.add.sprite(288, 174, 'item2');
	equal = game.add.sprite(368, 184, 'equal');
	object2 = game.add.sprite(432, 174, 'number5');
	operator = game.add.sprite(512, 184, 'plus');
	object2 = game.add.sprite(576, 174, 'item1');
	
	// Row 3
	object3 = game.add.sprite(288, 247, 'item2');
	equal = game.add.sprite(368, 257, 'equal');
	object3 = game.add.sprite(432, 247, 'number3');
	operator = game.add.sprite(512, 257, 'multiply');
	object3 = game.add.sprite(576, 247, 'item3');
