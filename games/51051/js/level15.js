...
create: function()
{
	...
	object1 = game.add.sprite(504, 101, 'item6');
	...
	result = game.add.bitmapText(680, 141, 'doctorSoosWhite', '5', 44);
	result.anchor.setTo(.5,.5);
	
	// Row 2
	
	object2 = game.add.sprite(360, 174, 'item4');
	...
	result = game.add.bitmapText(680, 214, 'doctorSoosWhite', '99', 44); 
	result.anchor.setTo(.5,.5);
	
	// Row 3
	object3 = game.add.sprite(216, 247, 'item6');
	object3 = game.add.sprite(360, 247, 'item6');
	object3 = game.add.sprite(504, 247, 'item6');
	
	operator = game.add.sprite(296, 257, 'plus');
	operator = game.add.sprite(440, 257, 'plus');
	equal = game.add.sprite(584, 257, 'equal');
	block = game.add.sprite(648, 247, 'blueblock');
	
	result = game.add.bitmapText(680, 287, 'doctorSoosWhite', '12', 44); 
	result.anchor.setTo(.5,.5);
