...
create: function()
{
	...
	object1 = game.add.sprite(576, 101, 'number1');
	...
	object2 = game.add.sprite(504, 174, 'number2');
	object2 = game.add.sprite(576, 174, 'number1');
	
	operator = game.add.sprite(296, 184, 'multiply');
	equal = game.add.sprite(440, 184, 'equal');
	
	// Row 3
	object3 = game.add.sprite(216, 247, 'number5');
	object3 = game.add.sprite(360, 247, 'number3');
	object3 = game.add.sprite(504, 247, 'number3');
	object3 = game.add.sprite(576, 247, 'number2');
	
	operator = game.add.sprite(296, 257, 'multiply');
	equal = game.add.sprite(440, 257, 'equal');
	
	// Row 4
	object4 = game.add.sprite(216, 320, 'number7');
	object4 = game.add.sprite(360, 320, 'number4');
	object4 = game.add.sprite(504, 320, 'number4');
	object4 = game.add.sprite(576, 320, 'number3');
	
	operator = game.add.sprite(296, 324, 'multiply');
	equal = game.add.sprite(440, 324, 'equal');
	
	
	// Row 5 (question)
	object4 = game.add.sprite(216, 393, 'number8');
	object4 = game.add.sprite(360, 393, 'number5');
	
	operator = game.add.sprite(296, 403, 'multiply');
	equal = game.add.sprite(440, 403, 'equal');
	
	block = game.add.sprite(504, 393, 'blueblock');
	
	questionMark = game.add.bitmapText(534, 403, 'doctorSoosWhite', '?', 60); 
