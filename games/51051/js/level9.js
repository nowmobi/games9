...
create: function()
{
	...
	// Row 1
	object1 = game.add.sprite(216, 101, 'item2');
	object1 = game.add.sprite(360, 101, 'item2');
	object1 = game.add.sprite(504, 101, 'item2');
	...
	result = game.add.bitmapText(680, 141, 'doctorSoosWhite', '27', 44);
	result.anchor.setTo(.5,.5);
	
	// Row 2
	object4 = game.add.sprite(144, 174, 'item3');
	operator = game.add.sprite(222, 184, 'multiply');
	object4 = game.add.sprite(288, 174, 'item3');
	operator = game.add.sprite(368, 184, 'multiply');
	object4 = game.add.sprite(432, 174, 'item2');
	operator = game.add.sprite(512, 184, 'multiply');
	object4 = game.add.sprite(576, 174, 'item3');
	equal = game.add.sprite(657, 184, 'equal');
	block = game.add.sprite(720, 174, 'redblock');
	
	result = game.add.bitmapText(750, 184, 'doctorSoosWhite', '24', 44); 
	result.anchor.setTo(.5,0);
	
	// Row 3
	object4 = game.add.sprite(144, 247, 'item2');
	operator = game.add.sprite(222, 257, 'multiply');
	object4 = game.add.sprite(288, 247, 'item4');
	operator = game.add.sprite(368, 257, 'multiply');
	object4 = game.add.sprite(432, 247, 'item3');
	operator = game.add.sprite(512, 257, 'multiply');
	object4 = game.add.sprite(576, 247, 'item4');
	equal = game.add.sprite(657, 257, 'equal');
	block = game.add.sprite(720, 247, 'blueblock');
	
	result = game.add.bitmapText(750, 257, 'doctorSoosWhite', '96', 44); 
	result.anchor.setTo(.5,0);
	
	// Row 4
	object4 = game.add.sprite(216, 393, 'item4');
