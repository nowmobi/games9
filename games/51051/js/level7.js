...
create: function()
{
	...
	// Row 1
	object1 = game.add.sprite(288, 101, 'number3');
	equal = game.add.sprite(368, 111, 'equal');
	object1 = game.add.sprite(432, 101, 'number1');
	object1 = game.add.sprite(504, 101, 'number8');
	
	// Row 2
	object2 = game.add.sprite(288, 174, 'number4');
	equal = game.add.sprite(368, 184, 'equal');
	object2 = game.add.sprite(432, 174, 'number3');
	object2 = game.add.sprite(504, 174, 'number2');
	
	// Row 3
	object3 = game.add.sprite(288, 247, 'number5');
	equal = game.add.sprite(368, 257, 'equal');
	object3 = game.add.sprite(432, 247, 'number5');
	object3 = game.add.sprite(504, 247, 'number0');
	
	// Row 4 
	object4 = game.add.sprite(288, 320, 'number6');
	equal = game.add.sprite(368, 330, 'equal');
	object4 = game.add.sprite(432, 320, 'number7');
	object4 = game.add.sprite(504, 320, 'number2');
	
	// Row 5 (question)
	object5 = game.add.sprite(288, 393, 'number8');
	equal = game.add.sprite(368, 403, 'equal');
	block = game.add.sprite(432, 393, 'orangeBlock');
	
	questionMark = game.add.bitmapText(462, 403, 'doctorSoosWhite', '?', 60); 
