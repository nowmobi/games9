...
create: function()
{
	...
	object4 = game.add.sprite(144, 247, 'number1');
	operator = game.add.sprite(222, 257, 'plus');
	object4 = game.add.sprite(288, 247, 'number1');
	operator = game.add.sprite(368, 257, 'plus');
	object4 = game.add.sprite(432, 247, 'number1');
	operator = game.add.sprite(512, 257, 'multiply');
	object4 = game.add.sprite(576, 247, 'number0');
	equal = game.add.sprite(649, 247, 'equal');
	block = game.add.sprite(720, 247, 'orangeBlock');
	
	questionMark = game.add.bitmapText(750, 257, 'doctorSoosWhite', '?', 60); 
