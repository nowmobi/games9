...
create: function()
{
	...
	// Row 1
	object1 = game.add.sprite(288, 101, 'number2');
	operator = game.add.sprite(368, 111, 'plus');
	object1 = game.add.sprite(432, 101, 'number4');
	equal = game.add.sprite(512, 111, 'equal');
	object1 = game.add.sprite(576, 101, 'number3');
	
	// Row 2
	object2 = game.add.sprite(288, 174, 'number4');
	operator = game.add.sprite(368, 184, 'plus');
	object2 = game.add.sprite(432, 174, 'number6');
	equal = game.add.sprite(512, 184, 'equal');
	object2 = game.add.sprite(576, 174, 'number5');
	
	// Row 3
	object3 = game.add.sprite(288, 247, 'number6');
	operator = game.add.sprite(368, 257, 'plus');
	object3 = game.add.sprite(432, 247, 'number8');
	equal = game.add.sprite(512, 257, 'equal');
	object3 = game.add.sprite(576, 247, 'number7');
	
	// Row 4 (question)
	object4 = game.add.sprite(288, 393, 'number1');
	operator = game.add.sprite(368, 403, 'plus');
	object4 = game.add.sprite(432, 393, 'number7');
