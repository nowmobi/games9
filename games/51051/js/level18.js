...
create: function()
{
	...
	// question text
	var textQuestion = game.add.bitmapText(W/2 - 10, 110, 'doctorSoosBlack', 'In what parking spot number is the car parked?', 34); 
	textQuestion.anchor.setTo(.5,0);
	
	// picture
	var question18 = game.add.sprite(W/2 - 10, 200, 'question18');
	question18.anchor.setTo(.5,0);
