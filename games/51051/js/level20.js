...
create: function()
{
	...
	// question text
	var textQuestion = game.add.bitmapText(W/2 - 10, 90, "doctorSoosBlack", "What's the answer?", 34); 
	textQuestion.anchor.setTo(.5,0);
	
	// picture
	var question20 = game.add.sprite(W/2 - 10, 170, 'question20');
	question20.anchor.setTo(.5,0);
	
	// 
	object1 = game.add.sprite(230, 360, 'number4');
	object1 = game.add.sprite(420, 360, 'number1');
	object1 = game.add.sprite(630, 360, 'blueblock');
	questionMark = game.add.bitmapText(663, 368, 'doctorSoosWhite', '?', 60); 
