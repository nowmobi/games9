...
create: function()
{
	...
	// question text
	var textQuestion = game.add.bitmapText(W/2 - 10, 90, 'doctorSoosBlack', 'How many squares are there?', 34); 
	textQuestion.anchor.setTo(.5,0);
	
	// picture
	var question19 = game.add.sprite(W/2 - 10, 150, 'question19');
	question19.anchor.setTo(.5,0);
