...
create: function()
{
	...
	// question text
	var textQuestion = game.add.bitmapText(W/2 - 10, 170, 'doctorSoosBlack', 'When I was 6, my sister was half of my age.', 40); 
	textQuestion.anchor.setTo(.5,0);
	
	textQuestion = game.add.bitmapText(W/2 - 10, 230, 'doctorSoosBlack', 'Now, I am 60, how old is my sister?', 40); 
	textQuestion.anchor.setTo(.5,0);
	
	object4 = game.add.sprite(400, 350, 'item3');
	object4 = game.add.sprite(490, 350, 'item5');
