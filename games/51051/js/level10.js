...
create: function()
{
	...
	object1 = game.add.sprite(576, 101, 'number8');
	
	operator = game.add.sprite(296, 111, 'multiply');
	equal = game.add.sprite(440, 111, 'equal');
	
	// Row 2
	object2 = game.add.sprite(216, 174, 'number9');
	object2 = game.add.sprite(360, 174, 'number1');
	object2 = game.add.sprite(504, 174, 'number8');
	object2 = game.add.sprite(576, 174, 'number1');
	object2 = game.add.sprite(648, 174, 'number0');
	
	operator = game.add.sprite(296, 184, 'multiply');
	equal = game.add.sprite(440, 184, 'equal');
	
	// Row 3
	object3 = game.add.sprite(216, 247, 'number8');
	object3 = game.add.sprite(360, 247, 'number7');
	object3 = game.add.sprite(504, 247, 'number1');
	object3 = game.add.sprite(576, 247, 'number1');
	object3 = game.add.sprite(648, 247, 'number5');
	
	operator = game.add.sprite(296, 257, 'multiply');
	equal = game.add.sprite(440, 257, 'equal');
	
	// Row 4
	object4 = game.add.sprite(216, 320, 'number6');
	object4 = game.add.sprite(360, 320, 'number2');
	object4 = game.add.sprite(504, 320, 'number4');
	object4 = game.add.sprite(576, 320, 'number8');
	...
	// Row 5 (question)
	object4 = game.add.sprite(216, 393, 'number7');
	object4 = game.add.sprite(360, 393, 'number4');
