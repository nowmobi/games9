...
create: function()
{
	...
	// Row 1
	object1 = game.add.sprite(288, 101, 'item6');
	object1 = game.add.sprite(432, 101, 'item1');
	
	operator = game.add.sprite(368, 111, 'plus');
	equal = game.add.sprite(511, 111, 'equal');
	block = game.add.sprite(576, 101, 'blueblock');
	
	result = game.add.bitmapText(604, 141, 'doctorSoosWhite', '6', 44);
	result.anchor.setTo(.5,.5);
	
	// Row 2
	object2 = game.add.sprite(288, 174, 'item3');
	object2 = game.add.sprite(432, 174, 'item6');
	
	operator = game.add.sprite(368, 184, 'plus');
	equal = game.add.sprite(511, 184, 'equal');
	block = game.add.sprite(576, 174, 'blueblock');
	
	result = game.add.bitmapText(604, 214, 'doctorSoosWhite', '10', 44);
	result.anchor.setTo(.5,.5);
	
	// Row 3
	object3 = game.add.sprite(288, 247, 'item1');
	object3 = game.add.sprite(432, 247, 'item3');
	
	operator = game.add.sprite(368, 257, 'plus');
	equal = game.add.sprite(511, 257, 'equal');
	block = game.add.sprite(576, 247, 'blueblock');
	
	result = game.add.bitmapText(604, 287, 'doctorSoosWhite', '8', 44);
	result.anchor.setTo(.5,.5);
	
	// Row 4
	object3 = game.add.sprite(216, 393, 'item1');
	object4 = game.add.sprite(360, 393, 'item6');
	object4 = game.add.sprite(504, 393, 'item3');
	
	operator = game.add.sprite(294, 403, 'plus');
	operator = game.add.sprite(440, 403, 'plus');
	equal = game.add.sprite(586, 403, 'equal');
	
	block = game.add.sprite(648, 393, 'blueblock');
