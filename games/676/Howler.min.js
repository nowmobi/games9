/*! howler.js v2.1.0 | (c) 2013-2018, James Simpson of GoldFire Studios | MIT License | howlerjs.com */ ! function() {
    "use strict";
    var e = function() {
        this.init()
    };
    ...
    o.prototype = {
        ...
        play: function(e, o) {
            ...
            if (!a) return null;
            if (r && !e && (e = a._sprite || "__default"), "loaded" !== t._state) {
            ...
            if (r && !a._paused) return o || t._loadQueue("play"), a._id;
            t._webAudio && n._autoResume();
            var i = Math.max(0, a._seek > 0 ? a._seek : t._sprite[e][0] / 1e3),
                d = Math.max(0, (t._sprite[e][0] + t._sprite[e][1]) / 1e3 - i),
                _ = 1e3 * d / Math.abs(a._rate),
                s = t._sprite[e][0] / 1e3,
                l = (t._sprite[e][0] + t._sprite[e][1]) / 1e3,
                c = !(!a._loop && !t._sprite[e][2]);
            a._sprite = e, a._ended = !1;
            var f = function() {
                a._paused = !1, a._seek = i, a._start = s, a._stop = l, a._loop = c
            };
            if (i >= l) return void t._ended(a);
            var p = a._node;
            if (t._webAudio) {
                var m = function() {
                    t._playLock = !1, f(), t._refreshBuffer(a);
                    var e = a._muted || t._muted ? 0 : a._volume;
                    p.gain.setValueAtTime(e, n.ctx.currentTime), a._playStart = n.ctx.currentTime, void 0 === p.bufferSource.start ? a._loop ? p.bufferSource.noteGrainOn(0, i, 86400) : p.bufferSource.noteGrainOn(0, i, d) : a._loop ? p.bufferSource.start(0, i, 86400) : p.bufferSource.start(0, i, d), _ !== 1 / 0 && (t._endTimers[a._id] = setTimeout(t._ended.bind(t, a), _)), o || setTimeout(function() {
                        t._emit("play", a._id), t._loadQueue()
                    }, 0)
                };
                "running" === n.state ? m() : (t._playLock = !0, t.once("resume", m), t._clearTimer(a._id))
            } else {
                var v = function() {
                        p.currentTime = i, p.muted = a._muted || t._muted || n._muted || p.muted, p.volume = a._volume * n.volume(), p.playbackRate = a._rate;
                        try {
                            var r = p.play();
                            if (r && "undefined" != typeof Promise && (r instanceof Promise || "function" == typeof r.then) ? (t._playLock = !0, f(), r.then(function() {
                                    t._playLock = !1, p._unlocked = !0, o || (t._emit("play", a._id), t._loadQueue())
                                }).catch(function() {
                                ...
                                })) : o || (t._playLock = !1, f(), t._emit("play", a._id), t._loadQueue()), p.playbackRate = a._rate, p.paused) return void t._emit("playerror", a._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction.");
                            "__default" !== e || a._loop ? t._endTimers[a._id] = setTimeout(t._ended.bind(t, a), _) : (t._endTimers[a._id] = function() {
                                t._ended(a), p.removeEventListener("ended", t._endTimers[a._id], !1)
                            }, p.addEventListener("ended", t._endTimers[a._id], !1))
                        } catch (e) {
                            t._emit("playerror", a._id, e)
                        }
                    },
                    h = window && window.ejecta || !p.readyState && n._navigator.isCocoonJS;
                if (p.readyState >= 3 || h) v();
                else {
                    t._playLock = !0;
                    var y = function() {
                        v(), p.removeEventListener(n._canPlayEvent, y, !1)
                    };
                    p.addEventListener(n._canPlayEvent, y, !1), t._clearTimer(a._id)
                }
            }
            return a._id
        },
