...
gdjs.evtsExt__HexagonalGrid__SnapObjectToBubbleGrid.userFunc0x8ab258 = function(runtimeScene, objects, eventsFunctionContext) {
"use strict";
// Insired from: https://www.redblobgames.com/grids/hexagons

const cellWidth = eventsFunctionContext.getArgument("CellWidth");
const cellHeight = eventsFunctionContext.getArgument("CellHeight") * 7/6;
...
var objects = [];
objects.push.apply(objects,gdjs.evtsExt__HexagonalGrid__SnapObjectToBubbleGrid.GDObjectObjects1);
gdjs.evtsExt__HexagonalGrid__SnapObjectToBubbleGrid.userFunc0x8ab258(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
