        ...
        switch (l) {
          ...
          case ">":
            switch (u) {
              ...
              case S_ATTR_SPACE:
                ...
                r.add(s, d.replace(/&#?\w+;/g, o), n)) : ("http://www.w3.org/1999/xhtml" === i[""] && d.match(/^(?:disabled|checked|selected)$/i) || a.warning('attribute "' + d + '" missed value!! "' + d + '" instead!!'), 
                r.add(d, d, n));
                break;
          ...
          default:
            if (l <= " ") switch (u) {
              ...
              case S_ATTR_SPACE:
                r.tagName;
                "http://www.w3.org/1999/xhtml" === i[""] && s.match(/^(?:disabled|checked|selected)$/i) || a.warning('attribute "' + s + '" missed value!! "' + s + '" instead2!!'), 
...
SaxO = {}, XMLReader.prototype = {
    ...
    for (var i = e.tagName, o = null, a = e.length; a--; ) {
        ...
        s.uri = "http://www.w3.org/2000/xmlns/", n.startPrefixMapping(p, u));
    }
    for (a = e.length; a--; ) {
...
DOMParser.prototype.parseFromString = function(e, n) {
    ...
    i.domBuilder = r.domBuilder || o, u && (c[""] = "http://www.w3.org/1999/xhtml"), 
    c.xml = c.xml || "http://www.w3.org/XML/1998/namespace", e ? i.parse(e, c, l) : i.errorHandler.error("invalid doc source"), 
    o.doc;
