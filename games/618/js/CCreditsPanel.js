function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oTitle = new CTLText(_oPanelContainer, 
                    -250, -160, 500, 80, 
                    80, "center", "#734313", PRIMARY_FONT, 1,
                    0, 0,
                    TEXT_DEVELOPED,
                    true, true, false,
                    false );
    ...
    this._onLogoButRelease = function(){
        window.open("https://newkidsgames.org/?utm_source=newkidsgames&utm_medium=granny_jigsaw_puzzle", target="_blank");
    };
