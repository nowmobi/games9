function CMenu(){
    ...
    this._init = function(){
        ...
        _oButPlay = new CGfxButton((CANVAS_WIDTH/2 - 160),CANVAS_HEIGHT/2 + 190,oSprite,s_oStage);
        _oButPlay.addEventListener(ON_MOUSE_UP, this._onButPlayRelease, this);
        _oButPlay.inversePulse();
		
		var oSprite = s_oSpriteLibrary.getSprite('more_games_main');
        _oButMore = new CGfxButton((CANVAS_WIDTH/2 + 160),CANVAS_HEIGHT/2 + 190,oSprite,s_oStage);
        _oButMore.addEventListener(ON_MOUSE_UP, this._onButMoreRelease, this);
	...
	this._onButMoreRelease = function(){
        window.open("https://newkidsgames.org/?utm_source=GameMonetize&utm_medium=granny_jigsaw_puzzle", target="_blank");
    };
