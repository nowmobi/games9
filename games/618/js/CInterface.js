function CInterface(){
    ...
    this._init = function(){      
        ...
        if (_fRequestFullScreen && screenfull.isEnabled){
            ...
            _pStartPosFullscreen = {x: oSprite.width/4,y:(oSprite.height/2)+4};
        ...
        _oTimeText = new createjs.Text(TEXT_TIME,"44px "+PRIMARY_FONT, "#8A583E");
        ...
        _oTimeNum = new createjs.Text("00:00","44px "+PRIMARY_FONT, "#ffffff");
