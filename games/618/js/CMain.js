function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'place',loop:false,volume:1, ingamename: 'place'});
    ...
    this._loadImages = function(){
		...
		s_oSpriteLibrary.addSprite("more_games_main","./sprites/more_games_main.png");
