...
window.zs = window.zs || {}, function(e) {
    ...
    var t = /* */ function() {
        ...
        _createClass2(t, [ {
            ...
            key: "loadNextSync",
            value: function loadNextSync(e, _t3, n) {
                var _this2 = this;
                if (this._isSceneLoading) return void zs.log.warn("正在加载其他场景······", "Scene");
                var i = null;
                ...
                this._handler = _t3, Laya.Scene3D.load(i, Laya.Handler.create(this, function(e) {
            ...
            key: "preload",
            value: function() {
                var _preload = _asyncToGenerator2(/* */ _regenerator.default.mark(function _callee3(e, _t4) {
                    var _e;
