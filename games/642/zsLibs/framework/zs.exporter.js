...
window.zs = window.zs || {}, window.zs.exporter = window.zs.exporter || {}, function (t) {
        ...
        _createClass2(s, null, [{
            ...
            value: function () {
                var _navigateToMiniProgram = _asyncToGenerator2(/* */ _regenerator.default.mark(function _callee(t, e) {
                    var i, r, a, n, _s5, _t, _s6, _t2, _s7, _e2;
    ...
    var l = /* */ function () {
        ...
        _createClass2(l, null, [{
            ...
            value: function collectExportNew(t, e, i, s) {
                ...
                var r = l.NEWURL + "/" + zs.network.version + "/ad/jump", a = null;
                if (null != i && null != s) (a = {}).group_id = i, a.img_id = s; else if (e) for (var _i2 = 0, _s8 = t.imgs.length; _i2 < _s8; _i2++) {
            ...
            value: function collectExportOld(t) {
                if ("wx_" != zs.platform.config.platformMark || "undefined" == typeof wx) return;
                var e = l.URL + "/api/appad_new/collect", i = Math.round(new Date().getTime() / 1e3).toString(), s = zs.platform.sync.getLaunchOptions(), r = {
                    user_id: zs.core.userId,
                                        ...
                                        for (var _t8 = 0, _e6 = i.length; _t8 < _e6; _t8++) {
                                            ...
                                            if (_e7.info.appid == _l2.appid) {
                                                _e7.info.imgs || (_e7.info.imgs = [], _e7.info.imgs.push(_e7.info.app_icon)), _e7.info.imgs.push(_l2.app_icon),
                                                    _e7.img_index = zs.utils.randInt(0, _e7.info.imgs.length), r = !0;
                                                break;
                                            }
                                        }
    ...
    var r = /* */ function (_zs$fgui$base) {
        ...
        _createClass2(r, [{
            ...
            value: function dispose() {
                _get2(_getPrototypeOf2(r.prototype), "dispose", this).call(this), this.startOffsetDelayHandler && clearTimeout(this.startOffsetDelayHandler),
            ...
            value: function setHorizontalList(t, s, _r, a) {
                var _this4 = this;
                return this.setItem(t).setLayout(fairygui.ListLayoutType.FlowVertical).setAlign(i.Center).setAdaptScale(!0).setKeepRatio(e.Vertical).setScrollType(fairygui.ScrollType.Horizontal).setColumnGap(25).setGridHeight(s).snapWidth().setAutoScrollSpeed(50).setDragRecoverTime(3).loop().setScrollExport().setMaxItems(_r),
            ...
            key: "setVerticalList",
            value: function setVerticalList(t, s, _r2, a) {
                var _this5 = this;
                return this.setItem(t).setLayout(fairygui.ListLayoutType.FlowHorizontal).setAlign(i.Center).setAdaptScale(!0).setKeepRatio(e.Horizontal).setScrollType(fairygui.ScrollType.Vertical).setLineGap(25).setGridWidth(s).snapHeight().setAutoScrollSpeed(50).setDragRecoverTime(3).loop().setMaxItems(_r2),
                    l.load().then(function (t) {
            ...
            key: "setSideList",
            value: function setSideList(t, s, _r3, a) {
                var _this6 = this;
                return this.setItem(t).setLayout(fairygui.ListLayoutType.FlowHorizontal).setAlign(i.Center).setAdaptScale(!0).setKeepRatio(e.Horizontal).setCellWidth(.7 * s).setScrollType(fairygui.ScrollType.Vertical).setLineGap(25).setGridWidth(s).setListFit(!0).bounce(!1).setMaxItems(_r3),
                    l.load().then(function (t) {
            ...
            value: function setHorizontalGrid(t, s, _r4, a, n, o) {
                var _this7 = this;
                return this.setItem(t).setLayout(fairygui.ListLayoutType.FlowHorizontal).setAlign(i.Center).setAdaptScale(!0).setKeepRatio(e.Horizontal).setCellWidth((s - 30 * a) / a).setScrollType(fairygui.ScrollType.Both).setLineGap(30).setLineCount(a).setColumnGap(30).setGridSize(s, _r4).bounce(!1).setMaxItems(n),
                    l.load().then(function (t) {
            ...
            key: "setVerticalGrid",
            value: function setVerticalGrid(t, s, _r5, a, n, o) {
                var _this8 = this;
                return this.setItem(t).setLayout(fairygui.ListLayoutType.FlowHorizontal).setAlign(i.Center).setAdaptScale(!0).setKeepRatio(e.Vertical).setCellHeight((_r5 - 30 * a) / a).setScrollType(fairygui.ScrollType.Both).setLineGap(30).setLineCount(a).setColumnGap(30).setGridSize(s, _r5).bounce(!1).setMaxItems(n),
                    l.load().then(function (t) {
    ...
    var a = /* */ function (_zs$fgui$base2) {
        ...
        _createClass2(a, [{
            key: "dispose",
            value: function dispose() {
                _get2(_getPrototypeOf2(a.prototype), "dispose", this).call(this), zs.network.behavior(zs.utils.getEventCode("full-" + this.fullId), 3, JSON.stringify(this.record)),
                    this.record = [];
            }
        }, {
            key: "setMistaken",
    ...
    a.gid = 0, a.checkScrollDistance = 30, t.utils = s, t.dataMgr = l, t.list = r, t.loader = /* */ function (_zs$fgui$base3) {
        ...
        _createClass2(_class4, [{
            ...
            value: function applyConfig(t) {
                if (t) {
                    ...
                    1 == _e18 ? (t.clickignore = !0, t.click_ignore = !0, t.firstclickignore = !1) : 2 == _e18 ? (t.clickignore = !1,
