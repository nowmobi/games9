    ...
    var i = /* */ function() {
        ...
        _createClass2(i, null, [ {
                    ...
                    return _regenerator.default.wrap(function _callee$(_context) {
                        while (1) {
                            switch (_context.prev = _context.next) {
                              ...
                              case 4:
                                _e = _context.sent;
                                _e && (_e.webDomains && (i.listDomain = _e.webDomains), _e.webApis && (_e.webApis.ping && (i.mapWebApi.ping = _e.webApis.ping), 
                                _e.webApis.login && (i.mapWebApi.login = _e.webApis.login), _e.webApis.config && (i.mapWebApi.config = _e.webApis.config), 
                                _e.webApis.update && (i.mapWebApi.update = _e.webApis.update), _e.webApis.download && (i.mapWebApi.download = _e.webApis.download)), 
            ...
            value: function() {
                ...
                //                     e._data = n;
                //                 }
                //                 return _context2.abrupt("return", new zs.Coop(function(_i, o) {
                ...
                //                             }
                //                             return r > 0 ? (zs.log.error("重复请求：" + t, c), _this.post(t, e, a, s, --r).then(o).catch(n)) : (zs.log.error("请求失败：" + t, c), 
                //                             n(c));
                //                         }
                //                     }, d.ontimeout = function(_i2) {
                //                         if (!g && !l) return g = !0, l = !0, r > 0 ? (zs.log.error("重复请求：" + t, _i2), _this.post(t, e, a, s, --r).then(o).catch(n)) : (zs.log.error("请求超时： " + t, _i2), 
                //                         n(_i2));
            ...
            value: function get(t, e, a, _i3) {
                var _this2 = this;
                return null == _i3 && (_i3 = 3), zs.platform.proxy && zs.platform.async.request ? new zs.Coop(function(s, r) {
                    zs.log.debug("通讯请求：" + t, "Network", e), zs.td.justTrack("通讯请求", "通讯请求"), zs.platform.async.request({
                        url: t,
                        data: JSON.stringify(e),
                        timeout: a,
                    ...
                    o.timeout = a || 1e4, zs.utils.sleep(o.timeout).then(function() {
                        ...
                        if (!d && !n) return d = !0, n = !0, _i3 > 0 ? (zs.log.error("重复请求：" + t, o), _this2.get(t, e, a, --_i3).then(s).catch(r)) : (zs.log.error("请求超时： " + t, o), 
                        r(o));
            ...
            value: function request(t, a, s) {
                ...
                //         switch (t) {
                //           case "config":
                //             a && "gmodule" === a.type ? a.gmodule ? (s = a.gmodule ? a.gmodule : "base_module", 
                ...
                //           case "config":
                //             var _e2 = null;
                //             a && "gmodule" === a.type ? a.gmodule ? (_e2 = a.gmodule ? a.gmodule : "base_module", 
                ...
                //         switch (t) {
                //           case "config":
                //             a && "gmodule" === a.type && (s = a.gmodule ? a.gmodule : "base_module", a.table && (s += "_" + a.table));
                //             break;
                            ...
                            switch (_context7.prev = _context7.next) {
                              ...
                              case 4:
                                r = {
                                    ...
                                    type: t ? "switch" : "gmodule",
                                    v: zs.configs.gameCfg.version
                                };
                                return _context7.abrupt("return", (t || (r.gmodule = e || "base_module", a && (r.table = a)), 
            ...
            key: "video",
            value: function video(t, e, a, _i5) {}
        }, {
            key: "behavior",
            ...
            value: function videoReport(t, e, a) {
                ...
                if (null == zs.core.userId || null == zs.core.userId) return void console.warn("没有uid");
                var r = zs.platform.async.getVideoId(), o = {
                    gid: window.zs.platform.config.platformMark + zs.configs.gameCfg.gameId,
                    uid: zs.core.userId,
                    uvid: r,
                    video_id: t,
