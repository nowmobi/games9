function CPreloader() {
    ...
    this.attachSprites = function() {
        ...
        _oIconMask.graphics.beginFill("rgba(0,0,0,0.01)").drawRoundRect(_oIcon.x - 960, _oIcon.y - 540, 1920, 1080, 10);
        ...
        _oButStart = new CTextButton(CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 300, oSprite, TEXT_PRELOADER_CONTINUE, PRIMARY_FONT, "#000", 50, _oContainer);
        _oButStart.addEventListener(ON_MOUSE_UP, this._onButStartRelease, this);
        _oButStart.addEventListener(ON_MOUSE_DOWN, this._GameMonetize, this);
    ...
    this._GameMonetize = (ON_MOUSE_UP, function() {
        sdk.showBanner();
    });
