function CPiece(iX, iY, iWidth, iHeight, iRadius, oJoints, iFrame, oSpriteMask, oSpriteEffect, oSpriteSheet, oParentContainer) {
    ...
    this._initHitAreas = function() {
        ...
        if (_oJoints.right !== null) {
            ...
            _aLogicCircleHitArea[JOINT_RIGHT] = {
                x: _oJoints.right[0],
                y: iY,
                pointer: oRect
            };
        ...
        if (_oJoints.down !== null) {
            ...
            _aLogicCircleHitArea[JOINT_DOWN] = {
                x: iX,
                y: _oJoints.down[1],
                pointer: oRect
            };
        ...
        if (_oJoints.left !== null) {
            ...
            _aLogicCircleHitArea[JOINT_LEFT] = {
                x: _oJoints.left[0],
                y: iY,
                pointer: oRect
            };
    ...
    this.moveTo = function(oPoint) {
        ...
        createjs.Tween.get(_oContainer).to({
            x: oPoint.x,
            y: oPoint.y,
            rotation: _iStartingRot
        }, 1000, createjs.Ease.cubicOut).call(function() {
            _bActive = true;
            s_oInterface.enableGUI(true);
        });
    };
    ...
    this.checkCollision = function(aHitAreaToCheck) {
        ...
        if (aHitAreaToCheck[JOINT_UP] !== null && aHitArea[JOINT_DOWN] !== null) {
            if (distance2(aHitAreaToCheck[JOINT_UP], aHitArea[JOINT_DOWN]) < DISTANCE_TO_CHECK) {
                return {
                    joint1: aHitArea[JOINT_DOWN].pointer,
                    joint2: aHitAreaToCheck[JOINT_UP].pointer,
                    dir: JOINT_UP
                };
            }
        }
        ...
        if (aHitAreaToCheck[JOINT_RIGHT] !== null && aHitArea[JOINT_LEFT] !== null) {
            if (distance2(aHitAreaToCheck[JOINT_RIGHT], aHitArea[JOINT_LEFT]) < DISTANCE_TO_CHECK) {
                return {
                    joint1: aHitArea[JOINT_LEFT].pointer,
                    joint2: aHitAreaToCheck[JOINT_RIGHT].pointer,
                    dir: JOINT_RIGHT
                };
            }
        }
        ...
        if (aHitAreaToCheck[JOINT_DOWN] !== null && aHitArea[JOINT_UP] !== null) {
            if (distance2(aHitAreaToCheck[JOINT_DOWN], aHitArea[JOINT_UP]) < DISTANCE_TO_CHECK) {
                return {
                    joint1: aHitArea[JOINT_UP].pointer,
                    joint2: aHitAreaToCheck[JOINT_DOWN].pointer,
                    dir: JOINT_DOWN
                };
            }
        }
        ...
        if (aHitAreaToCheck[JOINT_LEFT] !== null && aHitArea[JOINT_RIGHT] !== null) {
            if (distance2(aHitAreaToCheck[JOINT_LEFT], aHitArea[JOINT_RIGHT]) < DISTANCE_TO_CHECK) {
                return {
                    joint1: aHitArea[JOINT_RIGHT].pointer,
                    joint2: aHitAreaToCheck[JOINT_LEFT].pointer,
                    dir: JOINT_LEFT
                };
            }
        }
    ...
    this._updateHitAreaPosition = function() {
        ...
        if (_aLogicCircleHitArea[JOINT_UP] !== null) {
            aHitArea[JOINT_UP] = {
                x: _oContainer.x - _oContainer.regX + _aLogicCircleHitArea[JOINT_UP].x,
        ...
        if (_aLogicCircleHitArea[JOINT_RIGHT] !== null) {
            aHitArea[JOINT_RIGHT] = {
                x: _oContainer.x - _oContainer.regX + _aLogicCircleHitArea[JOINT_RIGHT].x,
        ...
        if (_aLogicCircleHitArea[JOINT_DOWN] !== null) {
            aHitArea[JOINT_DOWN] = {
                x: _oContainer.x - _oContainer.regX + _aLogicCircleHitArea[JOINT_DOWN].x,
        ...
        if (_aLogicCircleHitArea[JOINT_LEFT] !== null) {
            aHitArea[JOINT_LEFT] = {
                x: _oContainer.x - _oContainer.regX + _aLogicCircleHitArea[JOINT_LEFT].x,
    ...
    this._onPieceDown = function(evt) {
        if (_bActive) {
            _pMouseOffset = {
                x: evt.stageX - _oContainer.x,
                y: evt.stageY - _oContainer.y
            };
            _pPrevCoord = {
                x: evt.stageX,
                y: evt.stageY
