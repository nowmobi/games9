...
! function(t) {
    ...
    var i = function() {
        function e() {}
        return e.language = "zh-CN", e.os = "Unknown", e.runtimeType = t.RuntimeType.WEB, e.engineVersion = "5.2.29", e.renderMode = "Unknown", e.boundingClientWidth = 0, e.boundingClientHeight = 0, e
    }();
