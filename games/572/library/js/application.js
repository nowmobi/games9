/*
* @author edapskov
* @copyright 2019 edapskov v 8.008
*/
function Application()
{
	...
	*/
	...
	var _BGCOLOR = "#ffffff";
	var _FONT = "Arial";
	var _TITLE = "Blondie in the Real World";
	...
	*/
	this.copyright = "© DL-Studio, v 8.008";
	/*
		...
		heroes:
		{
			hero_1:{
				...
				totalDress:{
					...
					dress_16:{rewarded:false},
					dress_17:{rewarded:false},
					dress_18:{rewarded:false},
					dress_19:{rewarded:false},
					dress_20:{rewarded:false},
					...
					shoes_9:{rewarded:false},
					shoes_10:{rewarded:false},
					shoes_11:{rewarded:false},
					...
					bag_7:{rewarded:false},
					bag_8:{rewarded:false},
					bag_9:{rewarded:false},
					bag_10:{rewarded:false},
	...
	*/
	function _onClickPlayRedirectBtnFunc(event)
	{
		...
		*/
		window.open("https://dl-girls.com/content/folder_1689011194" + "?utm_source=" + window.location.href + "&utm_medium=game_referral|game&utm_content=simple&utm_campaign=" + _TITLE, "_self");
	}
	/*
